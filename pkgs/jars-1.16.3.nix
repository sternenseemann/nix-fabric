...

{
  ...
  carpet =
    ...
    in fetchMinecraftJar {
      ...
      sha256 = "1cvb753b1y59w3d8h2mkp4254w0ckrmwfa42znh0f6qz6jpd14kq";
      meta = {
  ...
  itemscroller = fetchMasaMod {
    ...
    date = "2020-09-12";
    time = "22:18:05";
    sha256 = "0zgj9krxs5dxdb5w8jv7ryjld06z5hb81rpaszlnh85l021n52i7";
  ...
  litematica = fetchMasaMod {
    ...
    date = "2020-09-20";
    time = "16:16:40";
    sha256 = "02d8bm2c6f0rwagxlvgcc1k109mw0a5yrala4hw54qx7j7h7as12";
    dependencies = [ malilib ];
    meta = {
  ...
  malilib = fetchMasaMod {
    ...
    sha256 = "080jszf61ac07yxcrxgzix4cy1mrvqahbcipny534p13cpz0qrbc";
    meta = {
  ...
  minihud = fetchMasaMod {
    ...
    date = "2020-10-27";
    time = "14:54:41";
    sha256 = "0krmvrb82kgj5vq09dxcrv0jw5xza92pk0xb54j6i8dj7bzmddix";
    dependencies = [ malilib ];
    meta = {
  ...
  tweakeroo = fetchMasaMod {
    ...
    date = "2020-10-04";
    time = "19:18:11";
    sha256 = "18b8qjza10ylsig6ca1kwn4n98dwlvb5ns2rgar859acvnk75h51";
    dependencies = [ malilib ];
    meta = {
